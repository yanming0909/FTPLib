...
package com.patent.ftpservice.server;

import android.util.Log;
import com.patent.ftpservice.Defaults;
import com.patent.ftpservice.FsService;
import com.patent.ftpservice.FsSettings;
...
public class SessionThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            Log.i(TAG, "Connection was dropped  "+e.getMessage());
            e.printStackTrace();
        }
        closeSocket();
    }
